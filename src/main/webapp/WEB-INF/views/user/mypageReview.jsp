	...
	if(confirm("게시물을 삭제 하시겠습니까?") == true)
	{
		$.ajax({
			...
			success:function(response)
			{
				...
				{
					alert("게시물이 삭제 되었습니다.");
					location.href = "/user/mypageReview";
				}
      ...
      <div class="css-1049nre epl9oik0">
         <style data-emotion="css 134c4us">.css-134c4us{display:-webkit-box;display:-webkit-flex;display:-ms-flexbox;display:flex;color:#292929;}</style>
            <div class="css-134c4us ekeuxnk0">
               ...
               <a class="css-1p9dybm e1q26atk3" href="/users/21129541/collections">
               ...
               <a class="css-1p9dybm e1q26atk3" href="/users/21129541/praises">
                  <div class="css-zpotx6 e1q26atk2">
            ...
            <a class="css-1p9dybm e1q26atk3" href="/user_shopping_pages/coupons">
               <div class="css-zpotx6 e1q26atk2">
                  <svg width="24" height="24" viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet">
                    ...
                    <h1 class="mytitle">내 리뷰
                          <c:choose>
						    ...
						    <c:otherwise>
						        ...
						        <c:forEach var="reviewMy" items="${list}">
...
<c:if test="${!empty list}">	
	<c:forEach var="reviewMy" items="${list}" varStatus="status">	
			  <div class="content-box">
...
<c:if test="${!empty paging}">	
	...
	<c:if test="${paging.nextBlockPage gt 0}">
 	...
 	<form name="myForm" id="myForm" method="post">
		<input type="hidden" name="productIdk" value="" />
