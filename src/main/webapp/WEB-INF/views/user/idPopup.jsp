...
var idSearch_click = function(){
	$.ajax({
		type:"POST",
		url:"${pageContext.request.contextPath}/user/userSearchId?inputName_1="
         ...
         <div class="content">
            <div class="signin-cont cont">
               <form name="form1" method="post">
                  <input type="text" name="inputName_1" id="inputName_1" class="inpt"
                     required="required" placeholder="사용자 이름"> 
                  <label for="text">ID</label>
                  
                  <input type="text" name="inputPhone_1" id="inputPhone_1" class="inpt" required="required"
                     placeholder="휴대폰 번호">
                  <label for="text">Password</label>
                  
                  <div class="submit-wrap">
                     <input type="button" id="searchBtn" value="아이디 찾기" onclick="idSearch_click()" class="submit"> 
                  </div><br><br>
                  
                  <h1>
					<b>입력하신 정보로 등록된 아이디는</b>
				  </h1>
				  <h1 id="id_value"></h1>
