...
<div class="container-xxl py-5">
  <div class="container">
    <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
      <h1 class="display-5 mb-4"><a href="/community/myroom" style="color:black">자유게시판 월간베스트</a></h1>
    </div>
...
<div class="container-xxl py-5">
  ...
  <div class="search-container">
    ...
    <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
      <h1 class="display-5 mb-4"><a href="/community/free" style="color:black">자유게시판</a></h1>
    </div>
