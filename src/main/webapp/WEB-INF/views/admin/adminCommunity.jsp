...
<body>
	...
	<div style="width:90%; margin:auto; margin-top:5rem;">
		...
		<div style="display:flex; margin-bottom:11.2px;">
            <div style="width:600px;"><pre style="height:50px;"><h2 style="margin-right:auto; color: #525252;">게시글 관리</h2></pre></div>
			<form class="d-flex" name="searchForm" id="searchForm" method="post" style="place-content: flex-end;">
				...
				<select id="userSearch" name="userSearch" style="font-size: 1rem; width: 8rem; height: 3rem; margin-left:.5rem; ">
              	...
              	<input type="text" name="userValue" id="userValue" style="width:15rem; height: 44px; margin-left:.5rem;"  value="">
				...
				<input type="text" name="searchValue" id="searchValue" style="width:15rem; height: 44px; margin-left:.5rem;" value="">
	
				<a class="btn my-2 my-sm-0" href="javascript:void(0)" onclick="fn_search()" style="height: 36px; text-align:center; display: flex; justify-content: center; align-items: center; width:7rem; margin-left:.5rem; background-color: rgb(239, 239, 239); border-color:rgb(118, 118, 118);">조회</a>
